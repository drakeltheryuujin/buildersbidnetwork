ActiveAdmin::Dashboards.build do
  ...
  section "Recent Projects" do
    ul do
      Project.order(:created_at).limit(5).collect do |project|
  ...
  section "Recent Profiles" do
    ul do
      Profile.order(:created_at).limit(5).collect do |profile|
        li link_to(profile.name, admin_profile_path(profile))
      end
    end
    strong { link_to "View All Profiels", admin_profiles_path }
  end
